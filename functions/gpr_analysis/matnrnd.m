...
% 
% FORMAT R = matnrnd(M,U,V,c,A,B) draws c random matrices from the matrix
...
% 
% First edit: 07/03/2018, 08:55 (V1.2/V18)
%  Last edit: 08/03/2018, 15:50 (V1.2/V18)
...
%-------------------------------------------------------------------------%
R = normrnd(0,1,[size(U,1), size(V,1), c]);
